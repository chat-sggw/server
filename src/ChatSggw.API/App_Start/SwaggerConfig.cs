...
namespace ChatSggw.API
{
    public class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        foreach (string xmlCommentsPath in GetXmlCommentsPaths())
                        {
        ...
        private static IEnumerable<string> GetXmlCommentsPaths()
        {
            ...
            string GetPathForAssembly(string assemblyName)
            {
                return Path.Combine(baseDirectory, $@"bin\{assemblyName}.XML");
            }

            yield return GetPathForAssembly("ChatSggw.API");
        }
    }
}
